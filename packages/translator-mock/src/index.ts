...
const sharedJapanese: TranslationCatalog = {
  ...
  "builder.questionId": "項目ID",
  "builder.questionIdRequired": "項目IDは必須です。",
  "builder.questionIdDuplicate": "項目ID「{{id}}」はすでに使用されています。",
  "builder.moveUp": "{{id}}を上へ移動",
  "builder.moveDown": "{{id}}を下へ移動",
  "builder.delete": "{{id}}を削除",
  "builder.deleteAction": "削除",
  "builder.titleKey": "タイトルキー",
  "builder.type": "種類",
  "builder.required": "必須",
  "builder.minimum": "最小値",
  "builder.maximum": "最大値",
  "builder.options": "選択肢",
  "builder.optionValue": "選択肢の値 {{index}}",
  "builder.optionLabel": "選択肢のラベル {{index}}",
  "builder.remove": "削除",
