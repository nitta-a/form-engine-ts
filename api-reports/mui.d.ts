...
declare function MuiBuilderNavigator({ schema, activeFieldId, onActiveFieldChange, selectedPageId, onSelectedPageChange, ariaLabel, pageLabel, questionsLabel, dense }: MuiBuilderNavigatorProps): react.JSX.Element;
...
type MuiBuilderPreviewProps = Omit<MuiContentRendererProps, "schema" | "onSubmit" | "autoSaveKey"> & {
    readonly schema: FormSchema;
    readonly locale?: string;
...
declare function MuiBuilderPreview({ schema, onSubmit, resetOnSuccess, ...props }: MuiBuilderPreviewProps): react.JSX.Element;
