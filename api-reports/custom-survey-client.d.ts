...
interface SurveySchemaTextMetadataCodec<TTextMetadata> {
...
interface SurveyTextMetadataInput {
    readonly value: string;
    readonly metadata?: SurveyTextMetadata;
    readonly sourceText: string;
    readonly sourceLocale?: string;
}
interface SurveyEngineText {
    readonly value: string;
    readonly sourceText: string;
    readonly metadata: Readonly<Record<string, JsonValue>>;
}
interface SurveyTextMetadataCodec {
    readonly toEngine: (input: SurveyTextMetadataInput) => SurveyEngineText;
    readonly fromEngine: (input: SurveyEngineText & {
        readonly metadata: SurveyEngineTextMetadata;
    }) => SurveyTextMetadata;
}
interface CreateSurveyTextMetadataCodecOptions {
...
interface SurveySchemaDomainAdapterOptions<TDomain, TTextMetadata = unknown> {
    readonly toFormSchema: (domain: TDomain) => FormSchema;
...
interface SurveySchemaDomainAdapterWithTextMetadata<TDomain, TTextMetadata = unknown> extends SurveySchemaDomainAdapter<TDomain> {
    readonly fromFormSchema?: (schema: FormSchema, previous: TDomain) => TDomain;
    readonly textMetadata?: SurveySchemaTextMetadataCodec<TTextMetadata>;
}
...
interface SurveySummaryLoader<TSummary> {
...
type SurveyResponseSummaryVariant = "default" | "rich";
...
interface SurveyResponseSummaryLanguageOption {
    readonly language: string;
    readonly count: number;
...
declare function createSurveySchemaDomainAdapter<TDomain, TTextMetadata>(input: SurveySchemaDomainAdapterOptions<TDomain, TTextMetadata>): SurveySchemaDomainAdapterWithTextMetadata<TDomain, TTextMetadata>;
...
interface SurveyMappingReorderResult<TMapping, TRevision = unknown> {
...
interface SurveyMappingMutationResult<TMapping, TRevision = unknown> {
...
type SurveyMappingMutationResponse<TMapping, TRevision = unknown> = TMapping | undefined | SurveyMappingMutationResult<TMapping, TRevision>;
interface SurveyMappingRevisionConflict<TMapping, TRevision = unknown> {
    readonly code: "REVISION_CONFLICT";
    readonly expectedRevision: TRevision;
    readonly currentRevision: TRevision;
    readonly currentMappings: readonly TMapping[];
}
declare class SurveyMappingRevisionConflictError<TMapping, TRevision = unknown> extends Error implements SurveyMappingRevisionConflict<TMapping, TRevision> {
    readonly code: "REVISION_CONFLICT";
    readonly expectedRevision: TRevision;
    readonly currentRevision: TRevision;
    readonly currentMappings: readonly TMapping[];
...
declare function isSurveyMappingRevisionConflict<TMapping, TRevision = unknown>(value: unknown): value is SurveyMappingRevisionConflict<TMapping, TRevision>;
interface SurveyMappingAtomicReorderRequest<TDomain, TMapping, TSelection, TRevision = unknown> {
    readonly domain: TDomain;
    readonly mappings: readonly TMapping[];
...
interface SurveyMappingCrudAdapter<TDomain, TMapping, TSelection, TRevision = unknown> {
    ...
    readonly reorderMany: (request: SurveyMappingAtomicReorderRequest<TDomain, TMapping, TSelection, TRevision>) => Promise<SurveyMappingReorderResult<TMapping, TRevision>>;
    /** Optional alias for reorderMany for hosts that use "all" terminology. */
    readonly reorderAll?: (request: SurveyMappingAtomicReorderRequest<TDomain, TMapping, TSelection, TRevision>) => Promise<SurveyMappingReorderResult<TMapping, TRevision>>;
    /** Optional alias for adapters that name the bulk operation after the resource. */
    readonly reorderMappings?: (request: SurveyMappingAtomicReorderRequest<TDomain, TMapping, TSelection, TRevision>) => Promise<SurveyMappingReorderResult<TMapping, TRevision>>;
...
type SurveyMappingAtomicCrudAdapter<TDomain, TMapping, TSelection, TRevision = unknown> = SurveyMappingCrudAdapter<TDomain, TMapping, TSelection, TRevision>;
type SurveyMappingCrudOperation = "idle" | "creating" | "removing" | "reordering" | "error";
interface SurveyMappingCrudState<TMapping, TRevision = unknown> {
...
interface UseSurveyMappingCrudResult<TMapping, TSelection = unknown, TRevision = unknown> {
    readonly mappings: readonly TMapping[];
    readonly revision?: TRevision;
    readonly state: {
        readonly operation: SurveyMappingCrudOperation;
    ...
    readonly reorderMany: (request: Omit<SurveyMappingAtomicReorderRequest<unknown, TMapping, TSelection, TRevision>, "domain">) => Promise<SurveyMappingReorderResult<TMapping, TRevision>>;
    ...
    readonly reorderAll?: (request: Omit<SurveyMappingAtomicReorderRequest<unknown, TMapping, TSelection, TRevision>, "domain">) => Promise<SurveyMappingReorderResult<TMapping, TRevision>>;
    readonly reorderMappings?: (request: Omit<SurveyMappingAtomicReorderRequest<unknown, TMapping, TSelection, TRevision>, "domain">) => Promise<SurveyMappingReorderResult<TMapping, TRevision>>;
    readonly refresh: () => Promise<boolean>;
}
interface UseSurveyMappingCrudOptions<TDomain, TMapping, TSelection, TRevision = unknown> {
    readonly domain: TDomain;
    readonly mappings: readonly TMapping[];
...
declare function useSurveyMappingCrud<TDomain, TMapping, TSelection = unknown, TRevision = unknown>(options: UseSurveyMappingCrudOptions<TDomain, TMapping, TSelection, TRevision>): UseSurveyMappingCrudResult<TMapping, TSelection, TRevision>;
...
declare function SurveyResponseSummary({ summary, version, sourceLanguage, onSourceLanguageChange, renderQuestion, slots, className, variant, locale, labels }: SurveyResponseSummaryComponentProps): React.JSX.Element;
...
type SurveyDefinitionQuestionType = "text" | "textarea" | "number" | "rating" | "radio" | "select" | "single-choice" | "checkbox" | "multi-select";
...
interface SurveyDefinitionRatingQuestion extends SurveyDefinitionQuestionBase {
...
interface SurveyDefinitionCheckboxQuestion extends SurveyDefinitionQuestionBase {
    readonly type: "checkbox";
}
type SurveyDefinitionQuestion = SurveyDefinitionTextQuestion | SurveyDefinitionNumberQuestion | SurveyDefinitionRatingQuestion | SurveyDefinitionChoiceQuestion | SurveyDefinitionSingleChoiceQuestion | SurveyDefinitionMultiSelectQuestion | SurveyDefinitionCheckboxQuestion;
...
type SurveyTranslationMetadataSource = "AI" | "MANUAL";
interface SurveyTranslationMetadataPolicy {
...
interface CreateSurveyTranslationMetadataOptions {
    readonly sourceLocale: string;
...
declare function createSurveyTranslationMetadata(slot: TranslationSlot, options: CreateSurveyTranslationMetadataOptions): Readonly<Record<string, JsonValue>>;
