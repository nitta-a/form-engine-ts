...
type SurveyResponseSummaryTabScope = "all" | "language";
type SurveyResponseSummaryTabOption = {
    readonly scope: "all";
    readonly count: number;
    readonly label?: ReactNode;
} | {
    readonly scope: "language";
    readonly language: string;
    readonly count: number;
    readonly label?: ReactNode;
};
type SurveyResponseSummaryTabSelection = {
    readonly scope: "all";
} | {
    readonly scope: "language";
    readonly language: string;
...
interface SurveyResponseSummaryTabsProps {
