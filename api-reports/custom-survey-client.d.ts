...
interface ApplyAndRecheckQualityResult<TApply, TQuality> {
...
declare function SurveyQualityPanel({ result, decisions, onDecide, onRequestAiFix, render, slots }: SurveyQualityPanelProps): React.JSX.Element;
