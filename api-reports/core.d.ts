...
declare function previewAuthoringSuggestion(schema: FormSchema, suggestion: AuthoringSuggestion, selectedOperationIdsOrPolicy?: readonly string[] | FormPolicy, policy?: FormPolicy): AuthoringPreview;
